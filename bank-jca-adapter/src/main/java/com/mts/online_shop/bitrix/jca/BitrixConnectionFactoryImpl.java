...
import com.mts.online_shop.bank.jca.BankRecordFactory;
import com.mts.online_shop.bank.jca.BankResourceAdapterMetaData;
...
public final class BitrixConnectionFactoryImpl implements ConnectionFactory, Serializable, Referenceable {
    ...
    BitrixConnectionFactoryImpl(BitrixManagedConnectionFactory mcf, ConnectionManager cm) {
        this.mcf = mcf;
        this.cm = cm;
    }
