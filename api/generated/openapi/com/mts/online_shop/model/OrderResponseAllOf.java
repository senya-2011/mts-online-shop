...
@JsonTypeName("OrderResponse_allOf")
...
public class OrderResponseAllOf {
  ...
  public OrderResponseAllOf items(List<@Valid CartItem> items) {
    this.items = items;
    return this;
  }

  public OrderResponseAllOf addItemsItem(CartItem itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, orderResponseAllOf.items);
  }
