...
public class ProductListResponse {
  ...
  @Valid
  private List<@Valid Product> items;
  ...
  public ProductListResponse items(List<@Valid Product> items) {
    this.items = items;
    return this;
  }

  public ProductListResponse addItemsItem(Product itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public ProductListResponse total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public ProductListResponse page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  */
  ...
  public ProductListResponse size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, productListResponse.items) &&
        Objects.equals(this.total, productListResponse.total) &&
        Objects.equals(this.page, productListResponse.page) &&
        Objects.equals(this.size, productListResponse.size);
  }
